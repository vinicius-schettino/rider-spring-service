...
public class DriverController {
    ...
    // pq não usar um put? - usar id nesse metodo é o correto mesmo? se não, como fazer? - como vamos ter varios caminhos diferentes para mudar para o mesmo estado não seria melhor deixar a maior parte da logica no service?
    @ResponseStatus(HttpStatus.OK)
