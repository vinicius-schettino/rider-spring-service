INSERT INTO PUBLIC.DRIVER(ID,NAME,EMAIL,STATUS) VALUES(UUID(),'Flavinho do Pneu','flavinhopneu@gmail.com','OFFLINE');
INSERT INTO PUBLIC.DRIVER(ID,NAME,EMAIL,STATUS) VALUES(UUID(),'Maria da Silva','mariasilva@gmail.com','OFFLINE');
